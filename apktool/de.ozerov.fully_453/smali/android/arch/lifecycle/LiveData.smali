...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/LiveData;->c:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    .line 69
    sget-object v0, Landroid/arch/lifecycle/LiveData;->c:Ljava/lang/Object;
...
.method private a(Landroid/arch/lifecycle/LiveData$b;)V
    ...
    .line 109
    iget-object p1, p1, Landroid/arch/lifecycle/LiveData$b;->c:Landroid/arch/lifecycle/m;
...
.method static synthetic b(Landroid/arch/lifecycle/LiveData;)Ljava/lang/Object;
    ...
    .line 59
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData;->g:Ljava/lang/Object;
...
.method private b(Landroid/arch/lifecycle/LiveData$b;)V
    ...
    .line 119
    iput-boolean v0, p0, Landroid/arch/lifecycle/LiveData;->j:Z
    ...
    .line 124
    :cond_2
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->d:Landroid/arch/a/b/b;
    ...
    .line 127
    iget-boolean v2, p0, Landroid/arch/lifecycle/LiveData;->j:Z
    ...
    :cond_4
    :goto_0
    iget-boolean v1, p0, Landroid/arch/lifecycle/LiveData;->j:Z
...
.method static synthetic c(Landroid/arch/lifecycle/LiveData;)I
    ...
    .line 59
    iget p0, p0, Landroid/arch/lifecycle/LiveData;->e:I
...
.method public a(Landroid/arch/lifecycle/f;)V
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/LiveData$b;->a(Landroid/arch/lifecycle/f;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/arch/lifecycle/LiveData;->b(Landroid/arch/lifecycle/m;)V
...
.method public a(Landroid/arch/lifecycle/f;Landroid/arch/lifecycle/m;)V
    .locals 2
    .param p1    # Landroid/arch/lifecycle/f;
        .annotation build Landroid/support/annotation/af;
        .end annotation
    .end param
    .param p2    # Landroid/arch/lifecycle/m;
        .annotation build Landroid/support/annotation/af;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/ac;
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/f;Landroid/arch/lifecycle/m;)V
    ...
    .line 172
    invoke-virtual {p2, p1}, Landroid/arch/lifecycle/LiveData$b;->a(Landroid/arch/lifecycle/f;)Z
...
.method public a(Landroid/arch/lifecycle/m;)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/arch/lifecycle/LiveData$a;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/m;)V
...
.method protected a(Ljava/lang/Object;)V
    ...
    .line 260
    :try_start_0
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->g:Ljava/lang/Object;

    sget-object v2, Landroid/arch/lifecycle/LiveData;->c:Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->k:Ljava/lang/Runnable;
...
.method public b()Ljava/lang/Object;
    ...
    .line 295
    sget-object v1, Landroid/arch/lifecycle/LiveData;->c:Ljava/lang/Object;
