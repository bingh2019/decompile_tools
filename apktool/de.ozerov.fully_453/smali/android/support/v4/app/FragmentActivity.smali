...
.field static final b:Ljava/lang/String; = "android:support:next_request_index"

.field static final c:Ljava/lang/String; = "android:support:request_indicies"

.field static final d:Ljava/lang/String; = "android:support:request_fragment_who"

.field static final e:I = 0xfffe
...
.field final h:Landroid/support/v4/app/m;
...
.field p:Landroid/support/v4/j/s;
...
.field private r:Landroid/arch/lifecycle/t;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->g:Landroid/os/Handler;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->h:Landroid/support/v4/app/m;
...
.method private static a(Landroid/support/v4/app/o;Landroid/arch/lifecycle/d$b;)Z
    ...
    .line 1062
    :cond_1
    invoke-virtual {v1}, Landroid/support/v4/app/Fragment;->a()Landroid/arch/lifecycle/d;
    ...
    .line 1063
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->al:Landroid/arch/lifecycle/g;

    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/g;->a(Landroid/arch/lifecycle/d$b;)V
    ...
    .line 1069
    invoke-static {v1, p1}, Landroid/support/v4/app/FragmentActivity;->a(Landroid/support/v4/app/o;Landroid/arch/lifecycle/d$b;)Z
...
.method private b(Landroid/support/v4/app/Fragment;)I
    ...
    .line 919
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/j/s;->g(I)I
    ...
    .line 930
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;

    iget-object p1, p1, Landroid/support/v4/app/Fragment;->y:Ljava/lang/String;

    invoke-virtual {v2, v0, p1}, Landroid/support/v4/j/s;->b(ILjava/lang/Object;)V
...
.method private l()V
    ...
    .line 1051
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->j()Landroid/support/v4/app/o;

    move-result-object v0

    sget-object v1, Landroid/arch/lifecycle/d$b;->c:Landroid/arch/lifecycle/d$b;

    invoke-static {v0, v1}, Landroid/support/v4/app/FragmentActivity;->a(Landroid/support/v4/app/o;Landroid/arch/lifecycle/d$b;)Z
...
.method public a()Landroid/arch/lifecycle/d;
    ...
    .line 324
    invoke-super {p0}, Landroid/support/v4/app/SupportActivity;->a()Landroid/arch/lifecycle/d;
...
.method final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 405
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->h:Landroid/support/v4/app/m;
...
.method public a(Landroid/support/v4/app/Fragment;Landroid/content/Intent;ILandroid/os/Bundle;)V
    ...
    .line 881
    :try_start_0
    invoke-static {p0, p2, v1, p4}, Landroid/support/v4/app/b;->a(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 889
    iput-boolean v2, p0, Landroid/support/v4/app/FragmentActivity;->n:Z
    ...
    .line 886
    invoke-static {p0, p2, p1, p4}, Landroid/support/v4/app/b;->a(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
    :try_end_1
...
.method public a(Landroid/support/v4/app/Fragment;Landroid/content/IntentSender;ILandroid/content/Intent;IIILandroid/os/Bundle;)V
    ...
    .line 899
    iput-boolean v1, v9, Landroid/support/v4/app/FragmentActivity;->m:Z
    ...
    .line 902
    :try_start_0
    invoke-static/range {v1 .. v8}, Landroid/support/v4/app/b;->a(Landroid/app/Activity;Landroid/content/IntentSender;ILandroid/content/Intent;IIILandroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 912
    iput-boolean v10, v9, Landroid/support/v4/app/FragmentActivity;->m:Z
...
.method public a(Landroid/support/v4/app/an;)V
    ...
    .line 217
    invoke-static {p0, p1}, Landroid/support/v4/app/b;->a(Landroid/app/Activity;Landroid/support/v4/app/an;)V
...
.method public b(Landroid/support/v4/app/an;)V
    ...
    .line 230
    invoke-static {p0, p1}, Landroid/support/v4/app/b;->b(Landroid/app/Activity;Landroid/support/v4/app/an;)V
...
.method public b_()Landroid/arch/lifecycle/t;
    ...
    .line 303
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->r:Landroid/arch/lifecycle/t;
    ...
    .line 308
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/t;

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->r:Landroid/arch/lifecycle/t;
...
.method public k()Landroid/support/v4/app/aa;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 150
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;

    invoke-virtual {v1, v0}, Landroid/support/v4/j/s;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/j/s;->c(I)V
...
.method public onBackPressed()V
    ...
    .line 182
    invoke-virtual {v0}, Landroid/support/v4/app/o;->j()Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 339
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/t;

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->r:Landroid/arch/lifecycle/t;
    ...
    iput-object v2, p0, Landroid/support/v4/app/FragmentActivity;->r:Landroid/arch/lifecycle/t;
    ...
    .line 344
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->h:Landroid/support/v4/app/m;

    if-eqz v0, :cond_1

    iget-object v1, v0, Landroid/support/v4/app/FragmentActivity$b;->c:Landroid/support/v4/app/q;

    :cond_1
    invoke-virtual {v4, v3, v1}, Landroid/support/v4/app/m;->a(Landroid/os/Parcelable;Landroid/support/v4/app/q;)V
    ...
    invoke-direct {v1, v3}, Landroid/support/v4/j/s;-><init>(I)V

    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;
    ...
    .line 358
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;

    aget v4, v0, v1

    aget-object v5, p1, v1

    invoke-virtual {v3, v4, v5}, Landroid/support/v4/j/s;->b(ILjava/lang/Object;)V
    ...
    .line 364
    :cond_4
    iget-object p1, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;
    ...
    iput-object p1, p0, Landroid/support/v4/app/FragmentActivity;->p:Landroid/support/v4/j/s;
    ...
    .line 369
    :cond_5
    iget-object p1, p0, Landroid/support/v4/app/FragmentActivity;->h:Landroid/support/v4/app/m;

    invoke-virtual {p1}, Landroid/support/v4/app/m;->h()V
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v0, p2, v1}, Landroid/support/v4/app/m;->a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
...
.method public onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/app/m;->b(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/app/m;->a(Landroid/view/MenuItem;)Z
...
.method protected onPause()V
    ...
    .line 472
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->g:Landroid/os/Handler;
    ...
    .line 474
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->f()V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    .line 548
    iget-object p2, p0, Landroid/support/v4/app/FragmentActivity;->h:Landroid/support/v4/app/m;

    invoke-virtual {p2, p3}, Landroid/support/v4/app/m;->a(Landroid/view/Menu;)Z
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/j/s;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/j/s;->c(I)V
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 569
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->g()Ljava/lang/Object;

    move-result-object v0

    .line 571
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->h:Landroid/support/v4/app/m;

    invoke-virtual {v1}, Landroid/support/v4/app/m;->g()Landroid/support/v4/app/q;
    ...
    iput-object v0, v2, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/t;

    .line 580
    iput-object v1, v2, Landroid/support/v4/app/FragmentActivity$b;->c:Landroid/support/v4/app/q;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 590
    invoke-direct {p0}, Landroid/support/v4/app/FragmentActivity;->l()V
    ...
    .line 596
    iget v1, p0, Landroid/support/v4/app/FragmentActivity;->o:I
    ...
    invoke-virtual {v1}, Landroid/support/v4/j/s;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/j/s;->b()I
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/j/s;->e(I)I
