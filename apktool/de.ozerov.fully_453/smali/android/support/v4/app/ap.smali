...
.method public static b(Landroid/content/Context;)Landroid/support/v4/app/ap;
    .locals 0
...
.method public a(II)Landroid/app/PendingIntent;
    ...
    .line 312
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/app/ap;->a(IILandroid/os/Bundle;)Landroid/app/PendingIntent;
...
.method public a(IILandroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    .line 344
    :cond_0
    iget-object p3, p0, Landroid/support/v4/app/ap;->c:Landroid/content/Context;
...
.method public a(I)Landroid/content/Intent;
    ...
    .line 234
    invoke-virtual {p0, p1}, Landroid/support/v4/app/ap;->b(I)Landroid/content/Intent;
...
.method public a(Landroid/app/Activity;)Landroid/support/v4/app/ap;
    ...
    .line 160
    instance-of v0, p1, Landroid/support/v4/app/ap$a;
    ...
    .line 172
    iget-object p1, p0, Landroid/support/v4/app/ap;->c:Landroid/content/Context;
    ...
    .line 174
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/app/ap;->a(Landroid/content/ComponentName;)Landroid/support/v4/app/ap;

    .line 175
    invoke-virtual {p0, v0}, Landroid/support/v4/app/ap;->a(Landroid/content/Intent;)Landroid/support/v4/app/ap;
...
.method public a(Landroid/content/ComponentName;)Landroid/support/v4/app/ap;
    ...
    invoke-static {v1, p1}, Landroid/support/v4/app/ab;->a(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
...
.method public a(Ljava/lang/Class;)Landroid/support/v4/app/ap;
    .locals 2
...
.method public b(Landroid/content/Intent;)Landroid/support/v4/app/ap;
    .locals 1
    .param p1    # Landroid/content/Intent;
        .annotation build Landroid/support/annotation/af;
        .end annotation
    ...
    .line 146
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/app/ap;->a(Landroid/content/Intent;)Landroid/support/v4/app/ap;
...
.method public c()[Landroid/content/Intent;
    ...
    iget-object v3, p0, Landroid/support/v4/app/ap;->b:Ljava/util/ArrayList;
