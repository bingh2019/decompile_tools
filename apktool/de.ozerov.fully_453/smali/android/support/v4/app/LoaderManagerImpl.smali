...
# instance fields
.field private final c:Landroid/arch/lifecycle/f;
...
.method constructor <init>(Landroid/arch/lifecycle/f;Landroid/arch/lifecycle/t;)V
    ...
    .param p1    # Landroid/arch/lifecycle/f;
        ...
        .end annotation
    .end param
    .param p2    # Landroid/arch/lifecycle/t;
        .annotation build Landroid/support/annotation/af;
        .end annotation
    .end param
    ...
    .line 372
    iput-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->c:Landroid/arch/lifecycle/f;
    ...
    iput-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->d:Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;

    return-void
.end method

.method private a(ILandroid/os/Bundle;Landroid/support/v4/app/aa$a;Landroid/support/v4/content/f;)Landroid/support/v4/content/f;
    .locals 2
    ...
    .line 383
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/aa$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/f;
    ...
    invoke-direct {v1, p1, p2, v0, p4}, Landroid/support/v4/app/LoaderManagerImpl$a;-><init>(ILandroid/os/Bundle;Landroid/support/v4/content/f;Landroid/support/v4/content/f;)V

    .line 395
    sget-boolean p2, Landroid/support/v4/app/LoaderManagerImpl;->b:Z
    ...
    .line 396
    :cond_2
    iget-object p2, p0, Landroid/support/v4/app/LoaderManagerImpl;->d:Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;
    ...
    .line 398
    iget-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->d:Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;

    invoke-virtual {p1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;->d()V

    .line 400
    iget-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->c:Landroid/arch/lifecycle/f;

    invoke-virtual {v1, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$a;->a(Landroid/arch/lifecycle/f;Landroid/support/v4/app/aa$a;)Landroid/support/v4/content/f;
...
# virtual methods
.method public a(ILandroid/os/Bundle;Landroid/support/v4/app/aa$a;)Landroid/support/v4/content/f;
    .locals 4
    .param p2    # Landroid/os/Bundle;
        .annotation build Landroid/support/annotation/ag;
        .end annotation
    ...
    .line 421
    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v4/app/LoaderManagerImpl;->a(ILandroid/os/Bundle;Landroid/support/v4/app/aa$a;Landroid/support/v4/content/f;)Landroid/support/v4/content/f;
    ...
    invoke-virtual {v0, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$a;->a(Landroid/arch/lifecycle/f;Landroid/support/v4/app/aa$a;)Landroid/support/v4/content/f;
...
.method public a(I)V
    ...
    .line 463
    invoke-virtual {v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$a;->a(Z)Landroid/support/v4/content/f;
...
.method public b(I)Landroid/support/v4/content/f;
    ...
    .line 476
    invoke-virtual {p1}, Landroid/support/v4/app/LoaderManagerImpl$a;->h()Landroid/support/v4/content/f;
...
.method public b(ILandroid/os/Bundle;Landroid/support/v4/app/aa$a;)Landroid/support/v4/content/f;
    .locals 3
    .param p2    # Landroid/os/Bundle;
        .annotation build Landroid/support/annotation/ag;
        .end annotation
    ...
    .line 447
    :cond_1
    invoke-direct {p0, p1, p2, p3, v1}, Landroid/support/v4/app/LoaderManagerImpl;->a(ILandroid/os/Bundle;Landroid/support/v4/app/aa$a;Landroid/support/v4/content/f;)Landroid/support/v4/content/f;
...
.method public toString()Ljava/lang/String;
    ...
    .line 490
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->c:Landroid/arch/lifecycle/f;
