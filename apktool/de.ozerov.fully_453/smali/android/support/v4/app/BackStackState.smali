...
.method public constructor <init>(Landroid/support/v4/app/i;)V
    ...
    .line 49
    iget-object v0, p1, Landroid/support/v4/app/i;->m:Ljava/util/ArrayList;
    ...
    .line 58
    iget-object v3, p1, Landroid/support/v4/app/i;->m:Ljava/util/ArrayList;
    ...
    iget v6, v3, Landroid/support/v4/app/i$a;->a:I
    ...
    iget-object v6, v3, Landroid/support/v4/app/i$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iget v6, v3, Landroid/support/v4/app/i$a;->c:I
    ...
    iget v6, v3, Landroid/support/v4/app/i$a;->d:I
    ...
    iget v6, v3, Landroid/support/v4/app/i$a;->e:I
    ...
    iget v3, v3, Landroid/support/v4/app/i$a;->f:I
    ...
    .line 66
    :cond_1
    iget v0, p1, Landroid/support/v4/app/i;->r:I
    ...
    .line 68
    iget-object v0, p1, Landroid/support/v4/app/i;->v:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    .line 69
    iget v0, p1, Landroid/support/v4/app/i;->x:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    .line 70
    iget v0, p1, Landroid/support/v4/app/i;->y:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    .line 71
    iget-object v0, p1, Landroid/support/v4/app/i;->z:Ljava/lang/CharSequence;
    ...
    .line 73
    iget-object v0, p1, Landroid/support/v4/app/i;->B:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    .line 74
    iget-object v0, p1, Landroid/support/v4/app/i;->C:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    .line 75
    iget-object v0, p1, Landroid/support/v4/app/i;->D:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    .line 76
    iget-boolean p1, p1, Landroid/support/v4/app/i;->E:Z
...
# virtual methods
.method public a(Landroid/support/v4/app/p;)Landroid/support/v4/app/i;
    .locals 7

    .line 95
    new-instance v0, Landroid/support/v4/app/i;

    invoke-direct {v0, p1}, Landroid/support/v4/app/i;-><init>(Landroid/support/v4/app/p;)V
    ...
    invoke-direct {v3}, Landroid/support/v4/app/i$a;-><init>()V
    ...
    iput v1, v3, Landroid/support/v4/app/i$a;->a:I
    ...
    .line 105
    iget-object v5, p1, Landroid/support/v4/app/p;->l:Landroid/util/SparseArray;
    ...
    .line 106
    iput-object v1, v3, Landroid/support/v4/app/i$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v1, v3, Landroid/support/v4/app/i$a;->c:I
    ...
    iput v1, v3, Landroid/support/v4/app/i$a;->d:I
    ...
    iput v1, v3, Landroid/support/v4/app/i$a;->e:I
    ...
    iput v1, v3, Landroid/support/v4/app/i$a;->f:I

    .line 114
    iget v1, v3, Landroid/support/v4/app/i$a;->c:I

    iput v1, v0, Landroid/support/v4/app/i;->n:I

    .line 115
    iget v1, v3, Landroid/support/v4/app/i$a;->d:I

    iput v1, v0, Landroid/support/v4/app/i;->o:I

    .line 116
    iget v1, v3, Landroid/support/v4/app/i$a;->e:I

    iput v1, v0, Landroid/support/v4/app/i;->p:I

    .line 117
    iget v1, v3, Landroid/support/v4/app/i$a;->f:I

    iput v1, v0, Landroid/support/v4/app/i;->q:I

    .line 118
    invoke-virtual {v0, v3}, Landroid/support/v4/app/i;->a(Landroid/support/v4/app/i$a;)V
    ...
    iput p1, v0, Landroid/support/v4/app/i;->r:I

    .line 122
    iget p1, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput p1, v0, Landroid/support/v4/app/i;->s:I

    .line 123
    iget-object p1, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object p1, v0, Landroid/support/v4/app/i;->v:Ljava/lang/String;

    .line 124
    iget p1, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput p1, v0, Landroid/support/v4/app/i;->x:I

    const/4 p1, 0x1

    .line 125
    iput-boolean p1, v0, Landroid/support/v4/app/i;->t:Z

    .line 126
    iget v1, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v1, v0, Landroid/support/v4/app/i;->y:I

    .line 127
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/i;->z:Ljava/lang/CharSequence;

    .line 128
    iget v1, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v1, v0, Landroid/support/v4/app/i;->A:I

    .line 129
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/i;->B:Ljava/lang/CharSequence;

    .line 130
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/i;->C:Ljava/util/ArrayList;

    .line 131
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/i;->D:Ljava/util/ArrayList;

    .line 132
    iget-boolean v1, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v1, v0, Landroid/support/v4/app/i;->E:Z

    .line 133
    invoke-virtual {v0, p1}, Landroid/support/v4/app/i;->e(I)V
