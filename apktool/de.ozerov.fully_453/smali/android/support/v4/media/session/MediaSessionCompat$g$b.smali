...
# instance fields
.field final synthetic X:Landroid/support/v4/media/session/MediaSessionCompat$g;
...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$g;)V
    ...
    .line 2653
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;
...
.method a(II)V
    ...
    .line 2962
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;
...
.method public a(IILjava/lang/String;)V
    ...
    .line 2745
    iget-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;
...
.method public a(Landroid/support/v4/media/session/a;)V
    ...
    iget-boolean v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->h:Z
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/support/v4/media/o$b;-><init>(Ljava/lang/String;II)V

    .line 2684
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;

    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->g:Landroid/os/RemoteCallbackList;
...
.method public b(Landroid/support/v4/media/session/a;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->g:Landroid/os/RemoteCallbackList;
...
.method public c()Ljava/lang/String;
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->c:Ljava/lang/String;
...
.method public d()Landroid/app/PendingIntent;
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->f:Ljava/lang/Object;
    ...
    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->n:Landroid/app/PendingIntent;
...
.method public e()J
    ...
    iget v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->k:I
...
.method public f()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    iget v4, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->w:I

    .line 2729
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;

    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->x:Landroid/support/v4/media/t;
    ...
    .line 2731
    invoke-virtual {v1}, Landroid/support/v4/media/t;->b()I

    move-result v2

    .line 2732
    invoke-virtual {v1}, Landroid/support/v4/media/t;->c()I

    move-result v5

    .line 2733
    invoke-virtual {v1}, Landroid/support/v4/media/t;->a()I
    ...
    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->d:Landroid/media/AudioManager;
    ...
    .line 2737
    iget-object v5, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;

    iget-object v5, v5, Landroid/support/v4/media/session/MediaSessionCompat$g;->d:Landroid/media/AudioManager;
...
.method public g()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->l:Landroid/support/v4/media/MediaMetadataCompat;
...
.method public h()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->m:Landroid/support/v4/media/session/PlaybackStateCompat;

    .line 2880
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$g$b;->X:Landroid/support/v4/media/session/MediaSessionCompat$g;

    iget-object v2, v2, Landroid/support/v4/media/session/MediaSessionCompat$g;->l:Landroid/support/v4/media/MediaMetadataCompat;
...
.method public i()Ljava/util/List;
    ...
    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->o:Ljava/util/List;
...
.method public j()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->p:Ljava/lang/CharSequence;
...
.method public k()Landroid/os/Bundle;
    ...
    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$g;->u:Landroid/os/Bundle;
...
.method public l()I
    ...
    iget v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->q:I
...
.method public m()Z
    ...
    iget-boolean v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->r:Z
...
.method public p()I
    ...
    iget v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$g;->t:I
