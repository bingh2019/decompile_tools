...
.field private static final M:Ljava/lang/String; = "data_calling_pkg"

.field private static final N:Ljava/lang/String; = "data_calling_pid"

.field private static final O:Ljava/lang/String; = "data_calling_uid"

.field private static final P:Ljava/lang/String; = "data_extras"
...
# instance fields
.field private final I:Landroid/support/v4/media/session/MediaSessionCompat$b;

.field private final J:Landroid/support/v4/media/session/MediaControllerCompat;
...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$b;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat;->K:Ljava/util/ArrayList;

    .line 518
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat;->I:Landroid/support/v4/media/session/MediaSessionCompat$b;
    ...
    invoke-static {p2}, Landroid/support/v4/media/session/f;->f(Ljava/lang/Object;)Z
    ...
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat;->J:Landroid/support/v4/media/session/MediaControllerCompat;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat;->I:Landroid/support/v4/media/session/MediaSessionCompat$b;
    ...
    .line 496
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat;->I:Landroid/support/v4/media/session/MediaSessionCompat$b;
    ...
    iput-object p5, p0, Landroid/support/v4/media/session/MediaSessionCompat;->I:Landroid/support/v4/media/session/MediaSessionCompat$b;
    ...
    .line 511
    sget p2, Landroid/support/v4/media/session/MediaSessionCompat;->H:I
    ...
    sput p1, Landroid/support/v4/media/session/MediaSessionCompat;->H:I
...
.method public a(I)V
    ...
    .line 589
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat;->I:Landroid/support/v4/media/session/MediaSessionCompat$b;
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    ...
    .line 548
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat;->I:Landroid/support/v4/media/session/MediaSessionCompat$b;
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$h;)V
    ...
    .line 888
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat;->K:Ljava/util/ArrayList;
...
.method public a(Z)V
    ...
    .line 643
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat;->K:Ljava/util/ArrayList;
...
.method public d()Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    .line 706
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat;->J:Landroid/support/v4/media/session/MediaControllerCompat;
...
.method public final g()Landroid/support/v4/media/o$b;
    .locals 1
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->h()Landroid/support/v4/media/o$b;
