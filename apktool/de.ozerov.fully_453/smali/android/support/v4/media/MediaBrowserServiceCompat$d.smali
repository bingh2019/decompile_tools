...
.method public a(Ljava/lang/String;ILandroid/os/Bundle;)Landroid/support/v4/media/i$a;
    ...
    invoke-static {v1, v2, v3}, Landroid/support/v4/app/j;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    .line 359
    :goto_0
    invoke-static {v1, v3, v2}, Landroid/support/v4/app/j;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d;->d:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    invoke-direct/range {v3 .. v9}, Landroid/support/v4/media/MediaBrowserServiceCompat$b;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;IILandroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$k;)V

    iput-object v10, v2, Landroid/support/v4/media/MediaBrowserServiceCompat;->m:Landroid/support/v4/media/MediaBrowserServiceCompat$b;
    ...
    iput-object v0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat;->m:Landroid/support/v4/media/MediaBrowserServiceCompat$b;
    ...
    .line 376
    invoke-virtual {p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$a;->b()Landroid/os/Bundle;
    ...
    :cond_5
    :goto_2
    new-instance p2, Landroid/support/v4/media/i$a;

    .line 381
    invoke-virtual {p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$a;->a()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p2, p1, v1}, Landroid/support/v4/media/i$a;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public a(Landroid/support/v4/media/o$b;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 344
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserServiceCompat$d;->b(Landroid/support/v4/media/o$b;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public a(Ljava/lang/String;Landroid/support/v4/media/i$c;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/support/v4/media/MediaBrowserServiceCompat$d$2;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$d;Ljava/lang/Object;Landroid/support/v4/media/i$c;)V
...
.method public b()Landroid/os/Bundle;
    ...
    .line 457
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d;->c:Landroid/os/Messenger;
...
.method b(Landroid/support/v4/media/o$b;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserServiceCompat$d$4;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$d;Landroid/support/v4/media/o$b;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method b(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 412
    iget-object p2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$d;->b:Ljava/lang/Object;

    invoke-static {p2, p1}, Landroid/support/v4/media/i;->a(Ljava/lang/Object;Ljava/lang/String;)V
