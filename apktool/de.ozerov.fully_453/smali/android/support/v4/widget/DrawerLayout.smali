...
.field private static final j:Ljava/lang/String; = "DrawerLayout"
...
# instance fields
.field private final A:Landroid/support/v4/widget/x;

.field private final B:Landroid/support/v4/widget/x;

.field private final C:Landroid/support/v4/widget/DrawerLayout$e;

.field private final D:Landroid/support/v4/widget/DrawerLayout$e;
...
.field private N:Landroid/support/v4/widget/DrawerLayout$c;
...
.field private ah:Landroid/graphics/Matrix;
...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v4/widget/DrawerLayout;->t:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/support/v4/widget/DrawerLayout$b;

    const/high16 p2, -0x67000000

    .line 201
    iput p2, p0, Landroid/support/v4/widget/DrawerLayout;->x:I
    ...
    iput-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->z:Landroid/graphics/Paint;
    ...
    .line 213
    iput p3, p0, Landroid/support/v4/widget/DrawerLayout;->H:I

    .line 214
    iput p3, p0, Landroid/support/v4/widget/DrawerLayout;->I:I

    .line 215
    iput p3, p0, Landroid/support/v4/widget/DrawerLayout;->J:I

    .line 216
    iput p3, p0, Landroid/support/v4/widget/DrawerLayout;->K:I

    const/4 v0, 0x0

    .line 238
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ab:Landroid/graphics/drawable/Drawable;

    .line 239
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ac:Landroid/graphics/drawable/Drawable;

    .line 240
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ad:Landroid/graphics/drawable/Drawable;

    .line 241
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ae:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$e;
    ...
    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$e;

    .line 323
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$e;

    const/high16 v3, 0x3f800000    # 1.0f

    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/x;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/x$a;)Landroid/support/v4/widget/x;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    .line 324
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {p3, p2}, Landroid/support/v4/widget/x;->a(I)V

    .line 325
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/x;->a(F)V

    .line 326
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$e;

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {p3, v4}, Landroid/support/v4/widget/DrawerLayout$e;->a(Landroid/support/v4/widget/x;)V

    .line 328
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$e;

    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/x;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/x$a;)Landroid/support/v4/widget/x;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;

    .line 329
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;

    const/4 v3, 0x2

    invoke-virtual {p3, v3}, Landroid/support/v4/widget/x;->a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/DrawerLayout$e;->a(Landroid/support/v4/widget/x;)V

    .line 334
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 336
    invoke-static {p0, p2}, Landroid/support/v4/view/ab;->e(Landroid/view/View;I)V
    ...
    invoke-static {p0, p2}, Landroid/support/v4/view/ab;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
    ...
    .line 341
    invoke-static {p0}, Landroid/support/v4/view/ab;->R(Landroid/view/View;)Z
    ...
    .line 353
    sget-object p3, Landroid/support/v4/widget/DrawerLayout;->k:[I
    ...
    iput-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->R:Landroid/graphics/drawable/Drawable;
    :try_end_0
    ...
    .line 364
    iput v1, p0, Landroid/support/v4/widget/DrawerLayout;->v:F
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->af:Ljava/util/ArrayList;
...
.method private a(FFLandroid/view/View;)Z
    ...
    .line 761
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ag:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ag:Landroid/graphics/Rect;
    ...
    .line 765
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->ag:Landroid/graphics/Rect;
...
.method private b(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
    ...
    .line 800
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ah:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->ah:Landroid/graphics/Matrix;
    ...
    .line 804
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->ah:Landroid/graphics/Matrix;
...
.method private c(Landroid/view/View;Z)V
    ...
    .line 906
    invoke-static {v2, v3}, Landroid/support/v4/view/ab;->e(Landroid/view/View;I)V
...
.method private f()Landroid/graphics/drawable/Drawable;
    ...
    .line 1166
    invoke-static {p0}, Landroid/support/v4/view/ab;->m(Landroid/view/View;)I
...
.method public a(I)I
    ...
    .line 689
    iget p1, p0, Landroid/support/v4/widget/DrawerLayout;->I:I

    goto :goto_0

    :cond_2
    iget p1, p0, Landroid/support/v4/widget/DrawerLayout;->H:I
    ...
    .line 676
    :cond_3
    iget p1, p0, Landroid/support/v4/widget/DrawerLayout;->J:I
...
.method public a(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/widget/DrawerLayout;->a(Landroid/graphics/drawable/Drawable;I)V
...
.method a(IILandroid/view/View;)V
    ...
    .line 814
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {p1}, Landroid/support/v4/widget/x;->b()I

    move-result p1

    .line 815
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;
    ...
    .line 838
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
    ...
    .line 843
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
    ...
    invoke-interface {p2, v1}, Landroid/support/v4/widget/DrawerLayout$c;->b(I)V
...
.method public a(ILandroid/view/View;)V
    ...
    .line 640
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/widget/DrawerLayout;->b(II)V
...
.method a(Landroid/view/View;F)V
    ...
    .line 921
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
...
.method public a(Landroid/view/View;Z)V
    ...
    .line 1702
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v0

    invoke-virtual {p2, p1, v1, v0}, Landroid/support/v4/widget/x;->a(Landroid/view/View;II)Z

    goto :goto_0

    .line 1704
    :cond_1
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;
    ...
    .line 1704
    invoke-virtual {p2, p1, v0, v1}, Landroid/support/v4/widget/x;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1654
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;
    ...
    .line 1654
    invoke-virtual {v7, v4, v6, v8}, Landroid/support/v4/widget/x;->a(Landroid/view/View;II)Z
    ...
    .line 1657
    :cond_1
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;
    ...
    .line 1657
    invoke-virtual {v6, v4, v7, v8}, Landroid/support/v4/widget/x;->a(Landroid/view/View;II)Z
    ...
    .line 1664
    :cond_3
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$e;

    invoke-virtual {p1}, Landroid/support/v4/widget/DrawerLayout$e;->a()V

    .line 1665
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$e;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 1934
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->af:Ljava/util/ArrayList;
    ...
    .line 1941
    :cond_5
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->af:Ljava/util/ArrayList;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 2074
    :goto_1
    sget-boolean p2, Landroid/support/v4/widget/DrawerLayout;->i:Z

    if-nez p2, :cond_2

    .line 2075
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/support/v4/widget/DrawerLayout$b;

    invoke-static {p1, p2}, Landroid/support/v4/view/ab;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method public b(I)Ljava/lang/CharSequence;
    ...
    .line 749
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->U:Ljava/lang/CharSequence;
    ...
    .line 751
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->V:Ljava/lang/CharSequence;
...
.method public b(II)V
    ...
    .line 597
    :goto_1
    invoke-virtual {p2}, Landroid/support/v4/widget/x;->g()V
...
.method public computeScroll()V
    ...
    .line 1315
    :cond_0
    iput v1, p0, Landroid/support/v4/widget/DrawerLayout;->y:F

    .line 1317
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/x;->a(Z)Z
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->y:F
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1433
    iget-object v3, v0, Landroid/support/v4/widget/DrawerLayout;->z:Landroid/graphics/Paint;
    ...
    iget-object v6, v0, Landroid/support/v4/widget/DrawerLayout;->z:Landroid/graphics/Paint;
    ...
    .line 1436
    :cond_5
    iget-object v3, v0, Landroid/support/v4/widget/DrawerLayout;->S:Landroid/graphics/drawable/Drawable;
    ...
    .line 1440
    iget-object v8, v0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {v8}, Landroid/support/v4/widget/x;->c()I
    ...
    .line 1443
    iget-object v6, v0, Landroid/support/v4/widget/DrawerLayout;->S:Landroid/graphics/drawable/Drawable;
    ...
    .line 1447
    :cond_6
    iget-object v3, v0, Landroid/support/v4/widget/DrawerLayout;->T:Landroid/graphics/drawable/Drawable;
    ...
    .line 1452
    iget-object v10, v0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/x;

    invoke-virtual {v10}, Landroid/support/v4/widget/x;->c()I
    ...
    .line 1455
    iget-object v6, v0, Landroid/support/v4/widget/DrawerLayout;->T:Landroid/graphics/drawable/Drawable;
...
.method g(Landroid/view/View;)Z
    ...
    .line 1470
    invoke-static {p1}, Landroid/support/v4/view/ab;->m(Landroid/view/View;)I

    move-result p1

    .line 1469
    invoke-static {v0, p1}, Landroid/support/v4/view/f;->a(II)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1488
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/x;

    invoke-virtual {v1, p1}, Landroid/support/v4/widget/x;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1489
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/x;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/x;->d(I)Z
    ...
    .line 1498
    iput p1, p0, Landroid/support/v4/widget/DrawerLayout;->Q:F
    ...
    invoke-virtual {v4, v0, p1}, Landroid/support/v4/widget/x;->e(II)Landroid/view/View;
    ...
    iget-boolean p1, p0, Landroid/support/v4/widget/DrawerLayout;->M:Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1218
    iput-boolean v2, v0, Landroid/support/v4/widget/DrawerLayout;->F:Z
    ...
    .line 1296
    iput-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout;->F:Z

    .line 1297
    iput-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout;->G:Z
...
.method protected onMeasure(II)V
    ...
    .line 1060
    iget-object v1, v0, Landroid/support/v4/widget/DrawerLayout;->W:Ljava/lang/Object;

    const/4 v5, 0x0

    if-eqz v1, :cond_5

    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ab;->R(Landroid/view/View;)Z
    ...
    .line 1061
    :goto_2
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ab;->m(Landroid/view/View;)I
    ...
    invoke-static {v15, v7}, Landroid/support/v4/view/f;->a(II)I

    move-result v15

    .line 1079
    invoke-static {v12}, Landroid/support/v4/view/ab;->R(Landroid/view/View;)Z
    ...
    .line 1081
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->W:Ljava/lang/Object;
    ...
    .line 1121
    sget-boolean v2, Landroid/support/v4/widget/DrawerLayout;->t:Z

    if-eqz v2, :cond_e

    .line 1122
    invoke-static {v12}, Landroid/support/v4/view/ab;->M(Landroid/view/View;)F

    move-result v2

    iget v14, v0, Landroid/support/v4/widget/DrawerLayout;->v:F
    ...
    .line 1123
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout;->v:F

    invoke-static {v12, v2}, Landroid/support/v4/view/ab;->m(Landroid/view/View;F)V
    ...
    .line 1142
    :goto_a
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout;->w:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/widget/x;->e(II)Landroid/view/View;
    ...
    .line 1592
    iget v1, p0, Landroid/support/v4/widget/DrawerLayout;->P:F

    sub-float/2addr v0, v1

    .line 1593
    iget v1, p0, Landroid/support/v4/widget/DrawerLayout;->Q:F
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/x;->f()I
...
.method public setDrawerElevation(F)V
    ...
    .line 380
    iget v1, p0, Landroid/support/v4/widget/DrawerLayout;->v:F

    invoke-static {v0, v1}, Landroid/support/v4/view/ab;->m(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/DrawerLayout$c;)V
    ...
    .line 493
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->N:Landroid/support/v4/widget/DrawerLayout$c;
    ...
    .line 501
    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->N:Landroid/support/v4/widget/DrawerLayout$c;
