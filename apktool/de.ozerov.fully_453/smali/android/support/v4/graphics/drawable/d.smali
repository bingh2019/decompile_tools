...
.method public static a(Landroid/content/res/Resources;Ljava/io/InputStream;)Landroid/support/v4/graphics/drawable/b;
    .locals 3
    .param p0    # Landroid/content/res/Resources;
        .annotation build Landroid/support/annotation/af;
        .end annotation
    ...
    invoke-static {p0, v0}, Landroid/support/v4/graphics/drawable/d;->a(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)Landroid/support/v4/graphics/drawable/b;

    move-result-object p0

    .line 98
    invoke-virtual {p0}, Landroid/support/v4/graphics/drawable/b;->b()Landroid/graphics/Bitmap;
...
.method public static a(Landroid/content/res/Resources;Ljava/lang/String;)Landroid/support/v4/graphics/drawable/b;
    .locals 3
    .param p0    # Landroid/content/res/Resources;
        .annotation build Landroid/support/annotation/af;
        .end annotation
