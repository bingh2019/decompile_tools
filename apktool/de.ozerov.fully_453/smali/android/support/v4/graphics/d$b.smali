.class public Landroid/support/v4/graphics/d$b;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/v4/graphics/d;
.end annotation
...
.method constructor <init>(C[F)V
    ...
    .line 321
    iput-char p1, p0, Landroid/support/v4/graphics/d$b;->a:C

    .line 322
    iput-object p2, p0, Landroid/support/v4/graphics/d$b;->b:[F
...
.method constructor <init>(Landroid/support/v4/graphics/d$b;)V
    ...
    .line 326
    iget-char v0, p1, Landroid/support/v4/graphics/d$b;->a:C

    iput-char v0, p0, Landroid/support/v4/graphics/d$b;->a:C

    .line 327
    iget-object v0, p1, Landroid/support/v4/graphics/d$b;->b:[F

    iget-object p1, p1, Landroid/support/v4/graphics/d$b;->b:[F

    array-length p1, p1

    const/4 v1, 0x0

    invoke-static {v0, v1, p1}, Landroid/support/v4/graphics/d;->a([FII)[F

    move-result-object p1

    iput-object p1, p0, Landroid/support/v4/graphics/d$b;->b:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    .line 650
    invoke-static/range {v0 .. v9}, Landroid/support/v4/graphics/d$b;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    .line 686
    invoke-static/range {v6 .. v24}, Landroid/support/v4/graphics/d$b;->a(Landroid/graphics/Path;DDDDDDDDD)V
...
.method public static a([Landroid/support/v4/graphics/d$b;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v0, v1, v3, v4}, Landroid/support/v4/graphics/d$b;->a(Landroid/graphics/Path;[FCC[F)V

    .line 341
    aget-object v1, p0, v2

    iget-char v1, v1, Landroid/support/v4/graphics/d$b;->a:C
...
# virtual methods
.method public a(Landroid/support/v4/graphics/d$b;Landroid/support/v4/graphics/d$b;F)V
    .locals 4
    ...
    .line 356
    :goto_0
    iget-object v1, p1, Landroid/support/v4/graphics/d$b;->b:[F
    ...
    .line 357
    iget-object v1, p0, Landroid/support/v4/graphics/d$b;->b:[F

    iget-object v2, p1, Landroid/support/v4/graphics/d$b;->b:[F
    ...
    iget-object v3, p2, Landroid/support/v4/graphics/d$b;->b:[F
