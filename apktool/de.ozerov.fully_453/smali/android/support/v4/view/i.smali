...
.method public static a(Landroid/view/LayoutInflater;)Landroid/support/v4/view/j;
    ...
    .line 170
    instance-of v0, p0, Landroid/support/v4/view/i$a;

    if-eqz v0, :cond_0

    .line 171
    check-cast p0, Landroid/support/v4/view/i$a;

    iget-object p0, p0, Landroid/support/v4/view/i$a;->a:Landroid/support/v4/view/j;
...
.method public static a(Landroid/view/LayoutInflater;Landroid/support/v4/view/j;)V
    ...
    .param p0    # Landroid/view/LayoutInflater;
        ...
        .end annotation
    .end param
    .param p1    # Landroid/support/v4/view/j;
        .annotation build Landroid/support/annotation/af;
        .end annotation
    .end param
    .annotation runtime Ljava/lang/Deprecated;
    ...
    .line 112
    new-instance v1, Landroid/support/v4/view/i$a;

    invoke-direct {v1, p1}, Landroid/support/v4/view/i$a;-><init>(Landroid/support/v4/view/j;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/view/i;->b(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V

    goto :goto_0

    .line 125
    :cond_3
    invoke-static {p0, v1}, Landroid/support/v4/view/i;->b(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V
...
.method public static a(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/i;->b(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V
...
.method private static b(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V
    ...
    .line 71
    sget-boolean v0, Landroid/support/v4/view/i;->c:Z
    ...
    sput-object v1, Landroid/support/v4/view/i;->b:Ljava/lang/reflect/Field;

    .line 74
    sget-object v1, Landroid/support/v4/view/i;->b:Ljava/lang/reflect/Field;
    ...
    .line 80
    :goto_0
    sput-boolean v0, Landroid/support/v4/view/i;->c:Z

    .line 82
    :cond_0
    sget-object v0, Landroid/support/v4/view/i;->b:Ljava/lang/reflect/Field;
