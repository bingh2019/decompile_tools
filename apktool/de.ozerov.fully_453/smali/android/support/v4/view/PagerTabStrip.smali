...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/support/v4/view/PagerTabStrip;->u:Landroid/graphics/Paint;
    ...
    iput-object p2, p0, Landroid/support/v4/view/PagerTabStrip;->v:Landroid/graphics/Rect;

    const/16 p2, 0xff

    .line 71
    iput p2, p0, Landroid/support/v4/view/PagerTabStrip;->w:I

    const/4 p2, 0x0

    .line 73
    iput-boolean p2, p0, Landroid/support/v4/view/PagerTabStrip;->x:Z

    .line 74
    iput-boolean p2, p0, Landroid/support/v4/view/PagerTabStrip;->y:Z
    ...
    iput p1, p0, Landroid/support/v4/view/PagerTabStrip;->D:I
...
.method a(IFZ)V
    ...
    iput p1, p0, Landroid/support/v4/view/PagerTabStrip;->w:I
    ...
    iget p2, p0, Landroid/support/v4/view/PagerTabStrip;->t:I
    ...
    iget p3, p0, Landroid/support/v4/view/PagerTabStrip;->t:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 271
    iget v3, p0, Landroid/support/v4/view/PagerTabStrip;->p:I

    sub-int v3, v0, v3

    .line 273
    iget-object v4, p0, Landroid/support/v4/view/PagerTabStrip;->u:Landroid/graphics/Paint;

    iget v5, p0, Landroid/support/v4/view/PagerTabStrip;->w:I

    shl-int/lit8 v5, v5, 0x18

    iget v6, p0, Landroid/support/v4/view/PagerTabStrip;->o:I
    ...
    .line 274
    iget-object v13, p0, Landroid/support/v4/view/PagerTabStrip;->u:Landroid/graphics/Paint;
    ...
    .line 276
    iget-boolean v1, p0, Landroid/support/v4/view/PagerTabStrip;->x:Z
    ...
    iget v3, p0, Landroid/support/v4/view/PagerTabStrip;->o:I
    ...
    iget v1, p0, Landroid/support/v4/view/PagerTabStrip;->z:I
    ...
    iget-object v6, p0, Landroid/support/v4/view/PagerTabStrip;->u:Landroid/graphics/Paint;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 229
    iget-boolean v2, p0, Landroid/support/v4/view/PagerTabStrip;->A:Z
...
.method public setDrawFullUnderline(Z)V
    ...
    .line 206
    iput-boolean p1, p0, Landroid/support/v4/view/PagerTabStrip;->y:Z
...
.method public setTabIndicatorColor(I)V
    ...
    .line 137
    iget-object p1, p0, Landroid/support/v4/view/PagerTabStrip;->u:Landroid/graphics/Paint;
