...
.method private b(Landroid/support/v7/widget/RecyclerView$i;II)Z
    ...
    .line 161
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ao;->c(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 166
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/ao;->a(Landroid/support/v7/widget/RecyclerView$i;II)I
    ...
    .line 171
    :cond_2
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/RecyclerView$t;->c(I)V
...
.method a()V
    ...
    .line 189
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ao;->a(Landroid/support/v7/widget/RecyclerView$i;)Landroid/view/View;
    ...
    .line 193
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/ao;->a(Landroid/support/v7/widget/RecyclerView$i;Landroid/view/View;)[I
...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 100
    iget-object p1, p0, Landroid/support/v7/widget/ao;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ao;->c:Landroid/widget/Scroller;
...
.method public a(II)Z
    ...
    .line 75
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroid/support/v7/widget/ao;->b(Landroid/support/v7/widget/RecyclerView$i;II)Z
...
.method protected b(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/z;
    ...
    .line 227
    :cond_0
    new-instance p1, Landroid/support/v7/widget/ao$2;
    ...
    invoke-direct {p1, p0, v0}, Landroid/support/v7/widget/ao$2;-><init>(Landroid/support/v7/widget/ao;Landroid/content/Context;)V
...
.method public b(II)[I
    ...
    .line 140
    iget-object p1, p0, Landroid/support/v7/widget/ao;->c:Landroid/widget/Scroller;
...
.method protected c(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/RecyclerView$t;
    ...
    .line 209
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ao;->b(Landroid/support/v7/widget/RecyclerView$i;)Landroid/support/v7/widget/z;
