...
.field d:Landroid/support/v7/widget/am$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 185
    iput-object v0, p0, Landroid/support/v7/widget/am;->c:Ljava/lang/String;

    .line 198
    iput-object p1, p0, Landroid/support/v7/widget/am;->b:Landroid/content/Context;
...
.method private i()V
    ...
    .line 383
    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/am$a;
    ...
    .line 386
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/am;->h:Landroid/support/v7/widget/c$f;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->h:Landroid/support/v7/widget/c$f;

    .line 389
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/am;->b:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v7/widget/am;->c:Ljava/lang/String;

    invoke-static {v0, v1}, Landroid/support/v7/widget/c;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v7/widget/c;

    move-result-object v0

    .line 390
    iget-object v1, p0, Landroid/support/v7/widget/am;->h:Landroid/support/v7/widget/c$f;
...
.method public a(Landroid/content/Intent;)V
    ...
    .line 345
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/am;->b(Landroid/content/Intent;)V
    ...
    .line 350
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/c;->a(Landroid/content/Intent;)V

    return-void
.end method

.method public a(Landroid/support/v7/widget/am$a;)V
    .locals 0

    .line 212
    iput-object p1, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/am$a;

    .line 213
    invoke-direct {p0}, Landroid/support/v7/widget/am;->i()V
...
.method public a(Landroid/view/SubMenu;)V
    ...
    .line 261
    iget-object v1, p0, Landroid/support/v7/widget/am;->b:Landroid/content/Context;
    ...
    .line 268
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/c;->a(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/am;->g:Landroid/support/v7/widget/am$c;
    ...
    .line 276
    iget-object v5, p0, Landroid/support/v7/widget/am;->b:Landroid/content/Context;
    ...
    .line 280
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/c;->a(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/am;->g:Landroid/support/v7/widget/am$c;
...
.method public a(Ljava/lang/String;)V
    ...
    .line 321
    iput-object p1, p0, Landroid/support/v7/widget/am;->c:Ljava/lang/String;
...
.method public b()Landroid/view/View;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/am;->c:Ljava/lang/String;
    ...
    .line 230
    iget-object v2, p0, Landroid/support/v7/widget/am;->b:Landroid/content/Context;
    ...
    invoke-static {v2, v1}, Landroid/support/v7/b/a/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
