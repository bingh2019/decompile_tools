...
.method public a(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 12447
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$x;->mShadowedHolder:Landroid/support/v7/widget/RecyclerView$x;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$x;->mShadowingHolder:Landroid/support/v7/widget/RecyclerView$x;

    if-nez v0, :cond_0

    .line 12448
    iput-object v1, p1, Landroid/support/v7/widget/RecyclerView$x;->mShadowedHolder:Landroid/support/v7/widget/RecyclerView$x;

    .line 12452
    :cond_0
    iput-object v1, p1, Landroid/support/v7/widget/RecyclerView$x;->mShadowingHolder:Landroid/support/v7/widget/RecyclerView$x;

    .line 12453
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$x;->shouldBeKeptAsChild()Z
