...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 274
    iput-boolean v0, p0, Landroid/support/v7/widget/c;->l:Z
    ...
    iput-object p1, p0, Landroid/support/v7/widget/c;->j:Landroid/content/Context;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/c;->k:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v7/widget/c;
    ...
    .line 330
    sget-object v0, Landroid/support/v7/widget/c;->q:Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v7/widget/c;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 334
    sget-object p0, Landroid/support/v7/widget/c;->r:Ljava/util/Map;
...
.method private f()V
    ...
    .line 574
    new-instance v1, Landroid/support/v7/widget/c$g;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/c$g;-><init>(Landroid/support/v7/widget/c;)V
    ...
    iget-object v5, p0, Landroid/support/v7/widget/c;->u:Ljava/util/List;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/c$g;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method private i()Z
    ...
    invoke-direct {v5, v3}, Landroid/support/v7/widget/c$b;-><init>(Landroid/content/pm/ResolveInfo;)V
...
.method private k()V
    ...
    check-cast v3, Landroid/support/v7/widget/c$e;
...
.method private l()V
    ...
    .line 1008
    new-instance v8, Landroid/support/v7/widget/c$e;

    invoke-direct {v8, v4, v6, v7, v5}, Landroid/support/v7/widget/c$e;-><init>(Ljava/lang/String;JF)V
...
.method public a(Landroid/content/pm/ResolveInfo;)I
    ...
    .line 424
    iget-object v0, p0, Landroid/support/v7/widget/c;->s:Ljava/lang/Object;
    ...
    .line 430
    iget-object v4, v4, Landroid/support/v7/widget/c$b;->a:Landroid/content/pm/ResolveInfo;
...
.method public a(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object p1, p1, Landroid/support/v7/widget/c$b;->a:Landroid/content/pm/ResolveInfo;
...
.method public a(Landroid/support/v7/widget/c$c;)V
    ...
    .line 588
    :try_start_0
    iget-object v1, p0, Landroid/support/v7/widget/c;->w:Landroid/support/v7/widget/c$c;
...
.method public b(I)Landroid/content/Intent;
    ...
    iget-object v3, p1, Landroid/support/v7/widget/c$b;->a:Landroid/content/pm/ResolveInfo;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/c;->v:Landroid/content/Intent;
    ...
    .line 473
    iget-object v3, p0, Landroid/support/v7/widget/c;->B:Landroid/support/v7/widget/c$f;
    ...
    invoke-interface {v4, p0, v3}, Landroid/support/v7/widget/c$f;->a(Landroid/support/v7/widget/c;Landroid/content/Intent;)Z
    ...
    invoke-direct {v2, v1, v3, v4, v5}, Landroid/support/v7/widget/c$e;-><init>(Landroid/content/ComponentName;JF)V

    .line 485
    invoke-direct {p0, v2}, Landroid/support/v7/widget/c;->a(Landroid/support/v7/widget/c$e;)Z
...
.method public c()Landroid/content/pm/ResolveInfo;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/c$b;->a:Landroid/content/pm/ResolveInfo;
...
.method public c(I)V
    ...
    iget v2, p1, Landroid/support/v7/widget/c$b;->b:F
    ...
    .line 550
    new-instance p1, Landroid/support/v7/widget/c$e;
    ...
    invoke-direct {p1, v2, v3, v4, v1}, Landroid/support/v7/widget/c$e;-><init>(Landroid/content/ComponentName;JF)V

    .line 552
    invoke-direct {p0, p1}, Landroid/support/v7/widget/c;->a(Landroid/support/v7/widget/c$e;)Z
