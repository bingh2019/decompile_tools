...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/z;->a(Landroid/util/DisplayMetrics;)F

    move-result p1

    iput p1, p0, Landroid/support/v7/widget/z;->n:F
...
.method public a(Landroid/view/View;I)I
    ...
    .line 303
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->e()Landroid/support/v7/widget/RecyclerView$i;
    ...
    .line 310
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$i;->q(Landroid/view/View;)I
    ...
    .line 313
    invoke-virtual/range {v4 .. v9}, Landroid/support/v7/widget/z;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    .line 137
    :cond_0
    iget p3, p0, Landroid/support/v7/widget/z;->g:I

    invoke-direct {p0, p3, p1}, Landroid/support/v7/widget/z;->b(II)I
    ...
    .line 138
    iget p1, p0, Landroid/support/v7/widget/z;->h:I

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/z;->b(II)I
    ...
    .line 141
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/z;->a(Landroid/support/v7/widget/RecyclerView$t$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/z;->d(I)Landroid/graphics/PointF;
    ...
    .line 241
    iput-object v0, p0, Landroid/support/v7/widget/z;->f:Landroid/graphics/PointF;
    ...
    .line 245
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/z;->b(I)I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->d:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$t$a;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/z;->b(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/z;->a(Landroid/view/View;I)I
    ...
    .line 115
    iget-object v1, p0, Landroid/support/v7/widget/z;->e:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v0, p0, Landroid/support/v7/widget/z;->n:F
...
.method protected c()I
    ...
    .line 207
    iget-object v0, p0, Landroid/support/v7/widget/z;->f:Landroid/graphics/PointF;
