...
.field private mLocalBroadcastManager:Landroid/support/v4/content/g;
    .annotation build Landroid/support/annotation/ag;
    .end annotation
.end field
...
.method static synthetic access$400(Lorg/altbeacon/bluetooth/BluetoothMedic;)Landroid/support/v4/content/g;
    .locals 0

    .line 65
    iget-object p0, p0, Lorg/altbeacon/bluetooth/BluetoothMedic;->mLocalBroadcastManager:Landroid/support/v4/content/g;
...
.method private initializeWithContext(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lorg/altbeacon/bluetooth/BluetoothMedic;->mLocalBroadcastManager:Landroid/support/v4/content/g;
    ...
    .line 159
    invoke-static {p1}, Landroid/support/v4/content/g;->a(Landroid/content/Context;)Landroid/support/v4/content/g;

    move-result-object p1

    iput-object p1, p0, Lorg/altbeacon/bluetooth/BluetoothMedic;->mLocalBroadcastManager:Landroid/support/v4/content/g;
...
.method private sendNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, v1}, Landroid/support/v4/app/ad$e;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 420
    invoke-virtual {v0, p2}, Landroid/support/v4/app/ad$e;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ad$e;
    ...
    .line 421
    invoke-virtual {p2, v0}, Landroid/support/v4/app/ad$e;->a(I)Landroid/support/v4/app/ad$e;
    ...
    .line 422
    invoke-virtual {p2, v0}, Landroid/support/v4/app/ad$e;->a([J)Landroid/support/v4/app/ad$e;

    move-result-object p2

    invoke-virtual {p2, p3}, Landroid/support/v4/app/ad$e;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ad$e;
    ...
    .line 430
    invoke-virtual {p2, p3}, Landroid/support/v4/app/ad$e;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ad$e;
    ...
    .line 434
    invoke-virtual {p2}, Landroid/support/v4/app/ad$e;->c()Landroid/app/Notification;
...
.method public enablePowerCycleOnFailures(Landroid/content/Context;)V
    ...
    .line 174
    iget-object p1, p0, Lorg/altbeacon/bluetooth/BluetoothMedic;->mLocalBroadcastManager:Landroid/support/v4/content/g;
    ...
    invoke-virtual {p1, v0, v1}, Landroid/support/v4/content/g;->a(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
