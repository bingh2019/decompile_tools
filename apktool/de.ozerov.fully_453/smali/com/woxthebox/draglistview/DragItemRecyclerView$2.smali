...
.method public run()V
    ...
    invoke-static {v1}, Lcom/woxthebox/draglistview/DragItemRecyclerView;->access$300(Lcom/woxthebox/draglistview/DragItemRecyclerView;)I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/woxthebox/draglistview/DragItemRecyclerView;->findViewHolderForAdapterPosition(I)Landroid/support/v7/widget/RecyclerView$x;
    ...
    invoke-virtual {v1}, Lcom/woxthebox/draglistview/DragItemRecyclerView;->getItemAnimator()Landroid/support/v7/widget/RecyclerView$f;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/RecyclerView$f;->d(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-direct {v3, p0, v0}, Lcom/woxthebox/draglistview/DragItemRecyclerView$2$1;-><init>(Lcom/woxthebox/draglistview/DragItemRecyclerView$2;Landroid/support/v7/widget/RecyclerView$x;)V
